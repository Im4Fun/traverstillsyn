...
function skapaUppsattning() {
  ...
  sh.appendRow([uid_('U'), 'Carl Rådetorp', '1234', 'admin', new Date().toISOString()]);
  sh.setFrozenRows(1);
  ...
  const traverser = [
    ['UH', '', 'Telfer plåtförrådet', '', 'Nej'],
    ['UH', '101', 'L1 pl. 4 schaktet utanför hissen', 'Kone telfer 5000 kg', 'Nej'],
    ['Prod/UH', '306', 'Valsförråd', 'Kone telfer 4000 kg', 'Nej'],
    ['UH', '308', 'Valsförråd', 'Kone travers 2x 8000 kg', 'Nej'],
    ['UH', '309', 'SW1 servicetravers RM 365', 'Kone travers 2x 2500 kg', 'Nej'],
    ['UH', '314', 'Packsrum', 'Kone travers 3200 kg', 'Nej'],
    ['Prod', '319', 'SW1 Uppstartsväv', 'Stahl travers 5000 / 3200 kg', 'Nej'],
    ['Prod/UH', '401', 'SW1 Högdel', 'Stahl travers 10000 kg', 'Nej'],
    ['UH', '402 A', 'SW1 Kalander', 'Hadef kättingspel 8000 kg', 'Ja'],
    ['UH', '402 B', 'SW1 Kalander', 'Hadef kättingspel 8000 kg', 'Ja'],
    ['Prod', '403', 'SW1 Pope/RM', 'Stahl travers 12600 / 3200 kg', 'Nej'],
    ['Prod', '404', 'SW2 RM465', 'Stahl travers 2x 6300 / 2x 125 kg', 'Nej'],
    ['Prod', '601', 'Screenstvätt', 'Stahl traverskran 2000 kg', 'Nej'],
    ['Prod', '602', 'Screenstvätt', 'Stahl traverskran 2000 kg', 'Nej'],
    ['UH', '605', 'UH-avd. stora', 'Kone travers 3200 kg', 'Nej'],
    ['UH', '606', 'UH-avd. arb-bänk', 'Kone telfer 1000 kg', 'Nej'],
    ['UH', '', 'SW2 Kalander servicetravers', 'Stahl traverskran 16000 kg', 'Ja'],
    ['Prod', '501', 'SW2 Högdel', 'Stahl traverskran 16000 kg', 'Nej'],
    ['Prod', '503', 'SW2 Pope', 'Stahl traverskran 12600 kg', 'Nej'],
    ['Prod', '620', 'SW3 Högdel', 'Kone 2x11000 kg', 'Nej'],
    ['Prod', '621', 'SW3 Mellandel Pope/RM', 'Kone 2x9000 kg', 'Nej'],
    ['Prod', '720', 'SW4 Högdel', 'Kone 2x7500 kg', 'Nej'],
    ['Prod', '721', 'SW4 Pope/RM', 'Kone 2x7500 kg', 'Nej']
  ];
  ...
  SpreadsheetApp.getUi().alert(
    ...
    '23 traverser, 13 checklistpunkter och adminkontot Carl Rådetorp har lagts in.\n\n' +
